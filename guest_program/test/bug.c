...
trigger(void)
{
	...
	msg->opcode = RX_SETUP;
	s2e_enable_forking();
//	s2e_make_symbolic(&(msg->can_id), sizeof(msg->can_id), "msg->can_id");
//	s2e_make_symbolic(&(msg->nframes), sizeof(msg->nframes), "msg->nframes");
//	s2e_make_symbolic(&(msg->opcode), sizeof(msg->opcode), "msg->opcode");
